...
typedef struct {
  ...
  const char* in_file;
  const char* out_file;
  const char* bank_files[4];
  const char* init_tbl_file;
  const char* preldr_file;
  const char* bldr_file;
  const char* kernel_file;
  const char* kernel_data_file;
  const char* mcpx_file;
  const char* bldr_key_file;
  const char* kernel_key_file;
  const char* public_key_file;
  const char* cert_key_file;
  const char* eeprom_key_file;
  const char* settings_file;
  const char* working_directory_path;
  const char* xcodes_file;
} XbToolParameters;
