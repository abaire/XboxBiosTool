...
#define RSA_PUBKEY_SIZE(rsa_header) \
  (sizeof(RSA_HEADER) + RSA_MOD_SIZE((RSA_HEADER*)rsa_header))
#define RSA_PUBKEY_BUFFER_SIZE(rsa_header) \
  (sizeof(RSA_HEADER) + RSA_MOD_BUFFER_SIZE(rsa_header))
